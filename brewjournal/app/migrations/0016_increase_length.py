...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourcedHopDetails.source'
        db.alter_column('app_sourcedhopdetails', 'source', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'SourcedHopDetails.source_url'
        db.alter_column('app_sourcedhopdetails', 'source_url', self.gf('django.db.models.fields.URLField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'SourcedHopDetails.source'
        db.alter_column('app_sourcedhopdetails', 'source', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SourcedHopDetails.source_url'
        db.alter_column('app_sourcedhopdetails', 'source_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
