...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Hop.aau_high'
        db.delete_column('app_hop', 'aau_high')

        # Deleting field 'Hop.aau_low'
        db.delete_column('app_hop', 'aau_low')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Hop.aau_high'
        raise RuntimeError("Cannot reverse this migration. 'Hop.aau_high' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Hop.aau_low'
        raise RuntimeError("Cannot reverse this migration. 'Hop.aau_low' and its values cannot be restored.")
