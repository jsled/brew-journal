...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BjcpCompetitionResults.entry_id'
        db.add_column('app_bjcpcompetitionresults', 'entry_id', orm['app.bjcpcompetitionresults:entry_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'BjcpCompetitionResults.entry_id'
        db.delete_column('app_bjcpcompetitionresults', 'entry_id')
