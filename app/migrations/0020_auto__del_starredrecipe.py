...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'app_starredrecipe')


    def backwards(self, orm):
        # Adding model 'StarredRecipe'
        db.create_table(u'app_starredrecipe', (
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Recipe'])),
            ('notes', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True)),
